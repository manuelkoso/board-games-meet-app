...
public class NewEventDialog {
    ...
    @NonNull
    private final EditText game;
    @NonNull
    private final EditText numberOfPlayers;
    @NonNull
    ...
    private NewEventDialog(@NonNull Fragment fragment) {
        ...
        time.setOnClickListener(v -> timePicker.show(fragment.getActivity().getSupportFragmentManager(), "MATERIAL_TIME_PICKER"));
